 ...
 */
package net.sf.dysis.base.ui.editor.validation;
		...
		scrolledForm.getForm().addMessageHyperlinkListener(
				new HyperlinkAdapter() {
					...
					public void linkActivated(HyperlinkEvent event) {
						...
						currentErrorShell.setBackground(ResourceManager
		...
		switch (type) {
			case IMessageProvider.ERROR:
				return ResourceManager.getPluginImage(Activator.getDefault(),
						"img/error_tsk.gif"); //$NON-NLS-1$
			case IMessageProvider.WARNING:
				return ResourceManager.getPluginImage(Activator.getDefault(),
						"img/warn_tsk.gif"); //$NON-NLS-1$
			case IMessageProvider.INFORMATION:
				return ResourceManager.getPluginImage(Activator.getDefault(),
						"img/info_tsk.gif"); //$NON-NLS-1$
		}
		return null;
	}
			...
			return new IValidator() {
				...
				public IStatus validate(Object value) {
					...
					if (valid) {
						...
						messageManager.addMessage(validatorId,
								Messages.getString("FormValidationAdapter.mandatory.message"), null, //$NON-NLS-1$
								IMessageProvider.ERROR, control);
						return new Status(IStatus.ERROR, Activator.PLUGIN_ID,
								Messages.getString("FormValidationAdapter.mandatory.field")); //$NON-NLS-1$
					}
				}
			};
		}
			...
			return new IValidator() {
				...
				public IStatus validate(Object value) {
					MultiStatus multiStatus = new MultiStatus(
							Activator.PLUGIN_ID, SWT.OK,
							Messages.getString("FormValidationAdapter.validation.error.message"), //$NON-NLS-1$
							null);
